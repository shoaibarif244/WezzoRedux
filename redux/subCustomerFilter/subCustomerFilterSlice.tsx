...
// const initialState: SubCustomersState = {
//   gridMoreItems: true,
//   isLoading: true,
...
//     },
//     pushToSubCustomersListData: (state, action: PayloadAction<ProductItem[]>) => {
...
//     },
//     clearSubCustomersListData: (state) => {
//       state.plpListData = [];
//       state.totalCount = 0;
//       state.totalPage = 1;
//       state.currentPage = 1;
...
//   setSubCategories,
//   setSelectedSubCategory,
//   pushToSubCustomersListData,
//   clearSubCustomersListData,
//   setTotalPage,
//   setTotalCount,
//   setIsLoading,
//   setIsFetchingMore,
...
const subCustomerFilterSlice = createSlice({
  name: 'filters',
  initialState,
  reducers: {
    setFilter: (state, action) => {
      state.activeFilter = action.payload.filter;
      state.activeValue = action.payload.value;
    },
    clearFilter: (state) => {
...
export const { setFilter, clearFilter } = subCustomerFilterSlice.actions;

export default subCustomerFilterSlice.reducer;
